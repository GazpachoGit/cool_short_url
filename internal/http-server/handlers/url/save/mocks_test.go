...
type MockMyInterface_Expecter struct {
	mock *mock.Mock
}

func (_m *MockMyInterface) EXPECT() *MockMyInterface_Expecter {
	return &MockMyInterface_Expecter{mock: &_m.Mock}
}

// SaveURL provides a mock function for the type MockMyInterface
func (_mock *MockMyInterface) SaveURL(urlToSave string, alias string) (int64, error) {
	ret := _mock.Called(urlToSave, alias)
...
// MockMyInterface_SaveURL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveURL'
type MockMyInterface_SaveURL_Call struct {
	*mock.Call
}
...
//   - urlToSave string
//   - alias string
func (_e *MockMyInterface_Expecter) SaveURL(urlToSave interface{}, alias interface{}) *MockMyInterface_SaveURL_Call {
	return &MockMyInterface_SaveURL_Call{Call: _e.mock.On("SaveURL", urlToSave, alias)}
}

func (_c *MockMyInterface_SaveURL_Call) Run(run func(urlToSave string, alias string)) *MockMyInterface_SaveURL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockMyInterface_SaveURL_Call) Return(n int64, err error) *MockMyInterface_SaveURL_Call {
	_c.Call.Return(n, err)
	return _c
}

func (_c *MockMyInterface_SaveURL_Call) RunAndReturn(run func(urlToSave string, alias string) (int64, error)) *MockMyInterface_SaveURL_Call {
	_c.Call.Return(run)
	return _c
}
